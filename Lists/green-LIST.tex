...
\NEW{Green}{\gSabotaging}{
  \s\MYname	{Sabotaging Devices}
  \s\MYfile	{Sabotaging.tex}
  }
  
\NEW{Green}{\gAntimatterBomb}{
  \s\MYname	{Creating an Antimatter Bomb}
  \s\MYfile	{AntimatterBomb.tex}
  }
